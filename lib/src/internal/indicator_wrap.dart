...
mixin IndicatorStateMixin<T extends StatefulWidget, V> on State<T> {
  PullexRefresh? refresher;

  RefreshConfiguration? configuration;
  PullexRefreshState? refresherState;
  ...
  void _updateListener() {
    ...
    refresher = PullexRefresh.of(context);
    refresherState = PullexRefresh.ofState(context);
  ...
  void initState() {
    // TODO: implement initState
    if (V == RefreshStatus) {
      PullexRefresh.of(context)?.controller.headerMode?.value =
          RefreshStatus.idle;
    }
    super.initState();
  }
